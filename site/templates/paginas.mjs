...
<section class="install" id="instalacao"><div class="wrap">
  ...
  <div class="install-cols">
    <div class="install-card">
      ...
      <div class="step"><span class="step-n">01</span><p>Baixe o arquivo <b>.skill</b> na página da skill (ou o kit completo).</p></div>
      <div class="step"><span class="step-n">02</span><p>No Claude, abra <b>Configurações › Capacidades › Criar habilidades</b>.</p></div>
      <div class="step"><span class="step-n">03</span><p>Clique em <b>Fazer upload de uma habilidade</b> e selecione o arquivo.</p></div>
      <div class="step"><span class="step-n">04</span><p>Comece qualquer conversa chamando a <b>coordenadora-central</b>.</p></div>
    </div>
    <div class="install-card">
